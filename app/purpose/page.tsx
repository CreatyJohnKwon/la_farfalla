    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen m-5 c_md:m-0">
            <div className="items-start">
                <h1 className="text-3xl c_base:text-7xl font-serif mb-20">LA_FARALLA's PURPOSE</h1>
                
                <div className="c_base:text-3xl font-light">
                    <span className="font-serif mt-2">LA_FARALLA </span><span>는 미래지향적이고 모던한 감각을 지닌 여성 브랜드로</span>
