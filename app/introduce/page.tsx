        ...
        <>
            ...
            <main className="flex h-full flex-col items-center justify-center p-5 text-center">
                <div className="flex min-h-[70vh] flex-col items-center justify-center">
                    <h1 className="font-brand mb-10 text-5xl transition-all duration-300 ease-in-out c_base:text-7xl">
                        Introduce
                    </h1>

                    <div className="font-brand-thin max-w-5xl space-y-4 text-lg transition-all duration-300 ease-in-out c_base:text-xl c_md:text-3xl">
                    ...
                    <button
                        className="mt-20 flex h-auto w-auto flex-row items-center justify-start hover:opacity-80"
