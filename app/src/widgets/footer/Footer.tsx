...
const Footer = () => {
    ...
    return (
        ...
        <footer className={`w-full y-full ${pathName === "/home" ? "mt-0" : "mt-24"}`}>
            <div className="flex flex-col justify-center items-center w-full y-full relative">
                ...
                <div
                    className={`
                        absolute bottom-full left-0 w-full mb-2 pb-4 sm:p-4
                ...
                >
                    ...
                    <div className={`bg-transparent ${pathName === "/home" ? "text-white" : "text-black"}`}>
                        <License />
                    </div>
                </div>

                {/* 버튼들은 기존과 동일합니다. */}
                <div className="flex flex-row h-12 sm:h-20 w-[90vw] sm:w-[95vw] text-black font-amstel justify-start items-center gap-10 text-sm sm:text-lg md:text-xl c_xl:text-2xl">
