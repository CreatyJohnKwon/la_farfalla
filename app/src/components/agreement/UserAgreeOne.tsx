    ...
    return (
        <>
            ...
            <div className="mt-8 h-[50vh] overflow-y-auto overflow-x-hidden p-2 text-start font-pretendard text-base">
                ...
                <br />
                <p>
                    이 약관은 OO 회사(전자상거래 사업자)가 운영하는 OO 사이버
                    몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하
                    “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의
                ...
                <p className="font-pretendard-bold">제2조(정의)</p>
                <p>
                    <br />
                </p>
                <p>
                    &nbsp; ① “몰”이란 OO 회사가 재화 또는 용역(이하 “재화
                ...
                <p>
                    ...
                    이상의 사전 유예기간을 두고 공지합니다. &nbsp;이 경우 "몰“은
                    개정 전 내용과 개정 후 내용을 명확하게 비교하여 이용자가
                    알기 쉽도록 표시합니다.&nbsp;
                </p>
                <p>
                    <br />
                ...
                <p>
                    ...
                    적용됩니다. 다만 이미 계약을 체결한 이용자가 개정약관 조항의
                    적용을 받기를 원하는 뜻을 제3항에 의한 개정약관의 공지기간
                    내에 “몰”에 송신하여 “몰”의 동의를 받은 경우에는 개정약관
                    조항이 적용됩니다.
                </p>
                <p>
                    <br />
                ...
                <p>
                    ...
                    관하여는 전자상거래 등에서의 소비자보호에 관한 법률, 약관의
                    규제 등에 관한 법률, 공정거래위원회가 정하는 전자상거래
                ...
                <p>
                    ...
                    이유로 서비스를 제공할 수 없게 되는 경우에는 “몰”은 제8조에
                    정한 방법으로 이용자에게 통지하고 당초 “몰”에서 제시한
                    조건에 따라 소비자에게 보상합니다. 다만, “몰”이 보상기준
                    등을 고지하지 아니한 경우에는 이용자들의 마일리지 또는
                    적립금 등을 “몰”에서 통용되는 통화가치에 상응하는 현물 또는
                    현금으로 이용자에게 지급합니다.
                </p>
                <p>
                    <br />
                </p>
                <p className="font-pretendard-bold">제6조(회원가입)&nbsp;</p>
                <p>
                    <br />
                </p>
                <p>
                ...
                <p>
                    &nbsp; &nbsp; 1. 가입신청자가 이 약관 제7조제3항에 의하여
                    이전에 회원자격을 상실한 적이 있는 경우, 다만 제7조제3항에
                    의한 회원자격 상실 후 3년이 경과한 자로서 “몰”의 회원재가입
                    승낙을 얻은 경우에는 예외로 한다.
                </p>
                <p>
                ...
                <p>
                    ...
                    상당한 기간 이내에 “몰”에 대하여 회원정보 수정 등의 방법으로
                    그 변경사항을 알려야 합니다.
                </p>
                <p>
                    <br />
                ...
                <p>
                    &nbsp; &nbsp; 3. 다른 사람의 “몰” 이용을 방해하거나 그
                    정보를 도용하는 등 전자상거래 질서를 위협하는 경우
                </p>
                <p>
                    &nbsp; &nbsp; 4. “몰”을 이용하여 법령 또는 이 약관이
                ...
                <p>
                    ...
                    2회 이상 반복되거나 30일 이내에 그 사유가 시정되지 아니하는
                    경우 “몰”은 회원자격을 상실시킬 수 있습니다.
                </p>
                <p>
                    <br />
                </p>
                ...
                <p className="font-pretendard-bold">제8조(회원에 대한 통지)</p>
                <p>
                    <br />
                </p>
                <p>
                ...
                <p>
                    &nbsp; &nbsp; &nbsp; 3. 약관내용, 청약철회권이 제한되는
                    서비스, 배송료․설치비 등의 비용부담과 관련한 내용에 대한
                    확인
                </p>
                <p>
                ...
                <p>
                    &nbsp; ② “몰”이 제3자에게 구매자 개인정보를 제공할 필요가
                    있는 경우 1) 개인정보를 제공받는 자, 2)개인정보를 제공받는
                    자의 개인정보 이용목적, 3) 제공하는 개인정보의 항목, 4)
                ...
                <p>
                    &nbsp; ③ “몰”이 제3자에게 구매자의 개인정보를 취급할 수
                    있도록 업무를 위탁하는 경우에는 1) 개인정보 취급위탁을 받는
                    자, 2) 개인정보 취급위탁을 하는 업무의 내용을 구매자에게
                    알리고 동의를 받아야 합니다. (동의를 받은 사항이 변경되는
                    경우에도 같습니다.) 다만, 서비스제공에 관한 계약이행을 위해
                    필요하고 구매자의 편의증진과 관련된 경우에는 「정보통신망
                    이용촉진 및 정보보호 등에 관한 법률」에서 정하고 있는
                    방법으로 개인정보 취급방침을 통해 알림으로써 고지절차와
                    동의절차를 거치지 않아도 됩니다.
                </p>
                <p>
                    <br />
                ...
                <p className="font-pretendard-bold">제10조 (계약의 성립)</p>
                <p>
                    <br />
                </p>
                <p>
                    &nbsp; ① &nbsp;“몰”은 제9조와 같은 구매신청에 대하여 다음 각
                    호에 해당하면 승낙하지 않을 수 있습니다. 다만, 미성년자와
                ...
                <p className="font-pretendard-bold">제11조(지급방법)</p>
                <br />
                <p>
                    “몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각
                    호의 방법중 가용한 방법으로 할 수 있습니다. 단, “몰”은
                ...
                <p>&nbsp; &nbsp; 5. 수령 시 대금지급</p>
                <p>
                    &nbsp; &nbsp; 6. 마일리지 등 “몰”이 지급한 포인트에 의한
                    결제
                </p>
                <p>
                    &nbsp; &nbsp; 7. “몰”과 계약을 맺었거나 “몰”이 인정한
                    상품권에 의한 결제 &nbsp;
                </p>
                <p>
                ...
                <p>
                    ...
                    취소를 요청할 수 있고 “몰”은 배송 전에 이용자의 요청이 있는
                ...
                <p className="font-pretendard-bold">제13조(재화 등의 공급)</p>
                <p>
                    <br />
                </p>
                <p>
                    &nbsp; ① “몰”은 이용자와 재화 등의 공급시기에 관하여 별도의
                    약정이 없는 이상, 이용자가 청약을 한 날부터 7일 이내에 재화
                    등을 배송할 수 있도록 주문제작, 포장 등 기타의 필요한 조치를
                    취합니다. 다만, “몰”이 이미 재화 등의 대금의 전부 또는
                    일부를 받은 경우에는 대금의 전부 또는 일부를 받은 날부터
                    3영업일 이내에 조치를 취합니다. &nbsp;이때 “몰”은 이용자가
                    재화 등의 공급 절차 및 진행 사항을 확인할 수 있도록 적절한
                    조치를 합니다.
                </p>
                <p>
                    <br />
                ...
                <p className="font-pretendard-bold">제14조(환급)</p>
                <br />
                <p>
                ...
                <p className="font-pretendard-bold">제15조(청약철회 등)</p>
                <p>
                    <br />
                </p>
                <p>
                ...
                <p>
                    ...
                    또는 훼손된 경우(다만, 재화 등의 내용을 확인하기 위하여 포장
                ...
                <p>
                    ...
                    때에는 당해 재화 등을 공급받은 날부터 3월 이내, 그 사실을 안
                    날 또는 알 수 있었던 날부터 30일 이내에 청약철회 등을 할 수
                    있습니다.
                </p>
                <p>
                    <br />
                ...
                <p>
                    ...
                    “몰”이 이용자에게 재화등의 환급을 지연한때에는 그 지연기간에
                ...
                <p>
                    ...
                    비용은 이용자가 부담합니다. “몰”은 이용자에게 청약철회 등을
                ...
                <p className="font-pretendard-bold">제17조(개인정보보호)</p>
                <p>
                    <br />
                </p>
                <p>
                ...
                <p className="font-pretendard-bold">제18조(“몰“의 의무)</p>
                <p>
                    <br />
                </p>
                <p>
                ...
                <p>
                    ...
                    사용하고 있음을 인지한 경우에는 바로 “몰”에 통보하고 “몰”의
                ...
                <p>
                    &nbsp; &nbsp; 4. “몰”이 정한 정보 이외의 정보(컴퓨터
                    프로그램 등) 등의 송신 또는 게시
                </p>
                <p>
                    &nbsp; &nbsp; 5. “몰” 기타 제3자의 저작권 등 지적재산권에
                    대한 침해
                </p>
                <p>
                    &nbsp; &nbsp; 6. “몰” 기타 제3자의 명예를 손상시키거나
                    업무를 방해하는 행위
                </p>
                <p>
                ...
                <p className="font-pretendard-bold">제23조(분쟁해결)</p>
                <p>
                    <br />
                </p>
                <p>
                ...
                <p className="font-pretendard-bold">제24조(재판권 및 준거법)</p>
                <p>
                    <br />
                </p>
                <p>
