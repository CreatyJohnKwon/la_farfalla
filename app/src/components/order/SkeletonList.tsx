    ...
    <>
        {Array.from({ length: 3 }).map((_, i) => (
            ...
            >
                ...
                <div className="mb-4 h-3 w-1/12 bg-gray-300" />
                <div className="mb-1 h-4 w-1/12 bg-gray-300" />
                <div className="mb-4 h-2 w-1/12 bg-gray-300" />
                <div className="mb-2 h-4 w-1/12 bg-gray-300" />
            </li>
        ))}
    </>
);
